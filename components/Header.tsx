        ...
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-4 group">
            <div className="hidden sm:block">
              <span className="text-xl font-normal text-white group-hover:text-[#1E97D4] transition-colors">T & L Roofing</span>
            </div>
          </Link>
          ...
          <div className="flex flex-col space-y-4 py-6 border-t border-white/20">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-gray-300 hover:text-[#1E97D4] transition-colors font-medium py-3 text-lg px-4"
