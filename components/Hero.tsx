      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center py-20 lg:py-32">
          ...
          <div className="inline-flex items-center bg-[#1E97D4]/20 backdrop-blur-sm px-6 py-3 rounded-full border border-[#1E97D4]/30 mb-8">
            <CheckCircle className="w-4 h-4 text-[#1E97D4] mr-2" />
            <span className="text-xs font-medium uppercase tracking-wide">Serving Leeds & West Yorkshire</span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto pt-12 border-t border-[#404040]">
            <div>
