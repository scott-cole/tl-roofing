...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      <section className="py-20 md:py-28 bg-[#292929]">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-8 mt-20 pt-20 border-t-2 border-[#404040]">
              {stats.map((stat, index) => (
                <div key={index} className="text-center flex-1 min-w-[150px]">
                  <div className="text-5xl md:text-6xl font-bold text-[#1E97D4] mb-2">
                    {stat.value}
                  </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              {values.map((value, index) => (
                <div
                  key={index}
                  className="bg-[#333333] rounded-2xl p-8 shadow-lg card-hover border border-[#4a4a4a] flex-1 min-w-[300px]"
                >
                  <div className="w-16 h-16 bg-[#1E97D4]/10 rounded-xl flex items-center justify-center text-[#1E97D4] mb-6">
                    {value.icon}
                  </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                <div className="w-14 h-14 bg-[#1E97D4]/10 rounded-xl flex items-center justify-center flex-shrink-0">
                  <Award className="w-7 h-7 text-[#1E97D4]" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-white mb-3">
              ...
              <div className="flex items-start space-x-4">
                <div className="w-14 h-14 bg-[#1E97D4]/10 rounded-xl flex items-center justify-center flex-shrink-0">
                  <Target className="w-7 h-7 text-[#1E97D4]" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-white mb-3">
                    Transparent Pricing
              ...
              <div className="flex items-start space-x-4">
                <div className="w-14 h-14 bg-[#1E97D4]/10 rounded-xl flex items-center justify-center flex-shrink-0">
                  <Shield className="w-7 h-7 text-[#1E97D4]" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-white mb-3">
              ...
              <div className="flex items-start space-x-4">
                <div className="w-14 h-14 bg-[#1E97D4]/10 rounded-xl flex items-center justify-center flex-shrink-0">
                  <Clock className="w-7 h-7 text-[#1E97D4]" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-white mb-3">
                    Local Knowledge
      ...
      <section className="py-20 md:py-28 bg-[#333333] text-white text-center">
        <div className="container">
